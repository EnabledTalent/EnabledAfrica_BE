...
import com.et.EnabledAfricaPlatform.repository.Jobs.EmployerRepository;
import com.et.EnabledAfricaPlatform.service.Jobs.JobService;
import com.et.EnabledAfricaPlatform.service.ai.JobPdfAiParserService;
...
public class EmployerJobController {
    ...
    private Long resolveEmployerId(String email, Authentication auth) {
        ...
        if (email == null || email.isBlank()) {
            ...
            throw new com.et.EnabledAfricaPlatform.exception.ForbiddenException("Employer identity missing in token");
        }

        Employer employer = employerRepository.findByEmail(email)
                .orElseThrow(() -> new com.et.EnabledAfricaPlatform.exception.ResourceNotFoundException("Employer not found"));
        ...
        if (authEmail == null || !authEmail.equalsIgnoreCase(email)) {
            throw new com.et.EnabledAfricaPlatform.exception.ForbiddenException("Unauthorized access");
        }
        return requestedEmployerId;
    }
}
