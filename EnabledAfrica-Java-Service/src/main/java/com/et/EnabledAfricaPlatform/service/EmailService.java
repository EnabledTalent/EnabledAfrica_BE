...
import com.et.EnabledAfricaPlatform.models.jobs.JobApplicationRequest;
...
public class EmailService {
    ...
    @Value("${email.brevo.from-name:Enabled Africa}")
    ...
    private void sendViaBrevo(String toEmail, String subject, String text) {
        try {
            String fromName = (brevoFromName != null && !brevoFromName.isBlank()) ? brevoFromName : "Enabled Africa";
